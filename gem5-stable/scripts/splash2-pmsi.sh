...
# Build X86_MSI_Snooping_One_Level_RT/gem5.opt
# Make sure to have build_opts/X86_MSI_Snooping_One_Level_RT defined
scons ./build/X86_MSI_Snooping_One_Level_RT/gem5.opt -j8

# Set SPLASH2 to point to SPLASH2 benchmark suite
SPLASH2="/home/shreyaseth1996/PMSI_CS533/gem5-stable/splash2/codes"

./build/X86_MSI_Snooping_One_Level_RT/gem5.opt  --stats-file=pmsi-Cholesky-stats.out ./configs/example/se.py  --ruby -n4 --cpu-type=timing --l1d_size=16kB --l1i_size=16kB --l1d_assoc=1 --l1i_assoc=1 --mem-size=4194304kB --topology=Crossbar --cpu-clock=2GHz --ruby-clock=2GHz --mem-type=SimpleMemory -c ${SPLASH2}/kernels/cholesky/cholesky -o "-p4 ${SPLASH2}/kernels/cholesky/inputs/tk14.O" 

./build/X86_MSI_Snooping_One_Level_RT/gem5.opt   --stats-file=pmsi-FFT-stats.out ./configs/example/se.py  --ruby -n4 --cpu-type=timing --l1d_size=16kB --l1i_size=16kB --l1d_assoc=1 --l1i_assoc=1  --mem-size=4194304kB --topology=Crossbar --cpu-clock=2GHz --ruby-clock=2GHz --mem-type=SimpleMemory -c ${SPLASH2}/kernels/fft/fft -o "-m 10 -p 4 -t" 

#./build/X86_MSI_Snooping_One_Level_RT/gem5.opt  --stats-file=pmsi-FMM-stats.out ./configs/example/se.py  --ruby -n4 --cpu-type=timing --l1d_size=16kB --l1i_size=16kB --l1d_assoc=1 --l1i_assoc=1  --mem-size=4194304kB --topology=Crossbar --cpu-clock=2GHz --ruby-clock=2GHz --mem-type=SimpleMemory -c ${SPLASH2}/apps/fmm/FMM 
...
./build/X86_MSI_Snooping_One_Level_RT/gem5.opt  --stats-file=pmsi-Radiosity-stats.out ./configs/example/se.py  --ruby -n4 --cpu-type=timing --l1d_size=16kB --l1i_size=16kB --l1d_assoc=1 --l1i_assoc=1  --mem-size=4194304kB --topology=Crossbar --cpu-clock=2GHz --ruby-clock=2GHz --mem-type=SimpleMemory -c ${SPLASH2}/apps/radiosity/RADIOSITY -o "-p 4 -batch" 

./build/X86_MSI_Snooping_One_Level_RT/gem5.opt  --stats-file=pmsi-Radix-stats.out ./configs/example/se.py  --ruby -n4 --cpu-type=timing --l1d_size=16kB --l1i_size=16kB --l1d_assoc=1 --l1i_assoc=1  --mem-size=4194304kB --topology=Crossbar --cpu-clock=2GHz --ruby-clock=2GHz --mem-type=SimpleMemory -c ${SPLASH2}/kernels/radix/RADIX -o "-p4 -n16384" 
...
./build/X86_MSI_Snooping_One_Level_RT/gem5.opt  --stats-file=pmsi-Barnes-stats.out ./configs/example/se.py  --ruby -n4 --cpu-type=timing --l1d_size=16kB --l1i_size=16kB --l1d_assoc=1 --l1i_assoc=1  --mem-size=4194304kB --topology=Crossbar --cpu-clock=2GHz --ruby-clock=2GHz --mem-type=SimpleMemory -c ${SPLASH2}/apps/barnes/BARNES

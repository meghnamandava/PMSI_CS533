...
int main(int argc, char *argv[])
{
  ...
  Global = (struct GlobalMemory *) G_MALLOC(sizeof(struct GlobalMemory));	
	...
	unsigned long long startAddr = (unsigned long long)&Global->idlock;
	//printf("\n startAddr: 0x%lx", startAddr);
	//m5_addsymbol(startAddr&~0x3F, (startAddr&~0x3F)+64);

	startAddr = (unsigned long long)&Global->start;
	//printf("\n startAddr: 0x%lx", startAddr);
	//m5_addsymbol(startAddr&~0x3F, (startAddr&~0x3F)+64);

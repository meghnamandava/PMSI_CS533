...
//   char particle_state[RANDOM_SIZE];
   ...
   for (i = 0; i < Total_Particles; i++)
	 ...
	 unsigned long long startAddr = (unsigned long long)&particle_array[0];
	 unsigned long long endAddr = (unsigned long long)&particle_array[Total_Particles-1];

	 //printf("\n S and E: %lx %lx", startAddr, endAddr);


	 startAddr = (unsigned long long)&Particle_List[0];
	 endAddr = (unsigned long long)&Particle_List[Total_Particles-1];
